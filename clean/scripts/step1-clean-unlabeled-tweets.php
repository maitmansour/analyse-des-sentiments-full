...
// Get TWeets by file
$tweets=getTweetsByFile("../dataset/step0-unlabeled.xml");
...
echo file_put_contents("/var/www/html/analyse-des-sentiments-full/clean/dataset/step1-clean-unlabeled-data.csv",$clean_messages_text);
